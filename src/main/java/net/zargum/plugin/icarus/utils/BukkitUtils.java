...
public class BukkitUtils {
    ...
    public static Player getPlayer(String string) {
        ...
        return JavaUtils.isUniqueId(string) ? Bukkit.getPlayer(UUID.fromString(string)) : Bukkit.getPlayer(string);
    }
    ...
    public static OfflinePlayer getOfflinePlayer(String string) {
        ...
        return JavaUtils.isUniqueId(string) ? Bukkit.getOfflinePlayer(UUID.fromString(string)) : Bukkit.getOfflinePlayer(string);
    }
