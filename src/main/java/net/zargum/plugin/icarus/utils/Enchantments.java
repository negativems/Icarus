...
public class Enchantments {
    ...
    static {
        ...
        ALIASENCHANTMENTS.put("fallprotect", Enchantment.PROTECTION_FALL);
        ALIASENCHANTMENTS.put("fallprot", Enchantment.PROTECTION_FALL);
        ALIASENCHANTMENTS.put("featherfall", Enchantment.PROTECTION_FALL);
        ...
        ALIASENCHANTMENTS.put("lucky", Enchantment.LUCK);
